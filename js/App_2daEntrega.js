...
do {
    ...
    if (opcion === 1) {
        ...
        // let reservaEncontrada = reservas.some((nuevaReserva) => nuevaReserva.codigoReserva === codigoReserva);
        //El problema se encuentra en la línea donde intentas buscar la reserva en el array utilizando el método some(). El método some() devuelve un valor booleano (true o false) indicando si al menos un elemento del array cumple con la condición establecida en la función de prueba.
